...
public class Cadd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String cnm=request.getParameter("n1");
        String gen=request.getParameter("n2");
        String mob=request.getParameter("n3");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Cadd</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            int res=stmt.executeUpdate("insert into customer values(custid.nextval,'"+cnm+"','"+gen+"',"+mn+",'"+add+"',sysdate)");
            if(res>0){
