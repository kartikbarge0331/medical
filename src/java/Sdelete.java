...
public class Sdelete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Sdelete</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            int res=stmt.executeUpdate("Delete From staff where EMPID="+eid+" ");
            
            if(res>0){
                out.println("<h3>1 row Deleteed</h3>");
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Sdelete.class.getName()).log(Level.SEVERE, null, ex);
